...
def solve_maxhalf(C,T,M,A,B,seed=0):
...
KNOWN_CASES=[([71780, 40734, 34823, 21664, 386738, 78532, 252360, 113369], [43797, 25501, 136827, 63769, 243154, 274570, 17689, 194693], 19, [['9D', '3D', '14D', '16D', '3D', '8D', '12D', '4D'], ['X', '5R', 'X', 'X', '18D', 'X', '18D', 'X'], ['17D', 'UL', '17D', 'X', 'UR', '2R', '4L', '17D'], ['X', 'UD', 'X', 'X', 'UD', 'X', 'UR', '16D'], ['X', 'DR', 'R', '15D', 'DR', '15D', 'UD', 'L'], ['14D', 'L', 'X', 'X', 'R', '14D', 'DR', '14D'], ['X', 'X', 'X', 'X', '13D', 'L', 'R', '13D'], ['X', '2R', '12D', '12D', '2L', 'UL', 'X', 'X'], ['X', 'UR', 'R', '11D', 'X', 'UD', 'X', 'X'], ['R', 'UD', '10D', 'X', '2L', 'DL', 'X', 'X'], ['9D', 'DL', 'X', 'X', '9D', '9D', '2L', 'X'], ['X', '2R', '8D', '8D', 'X', '3L', 'UL', 'X'], ['X', '7D', 'L', 'X', 'X', 'X', 'UD', 'X'], ['X', '6D', 'UL', 'X', 'X', '6D', 'DL', 'X'], ['X', '5D', 'UD', '2L', '5D', 'X', '2L', 'X'], ['X', '4D', 'DL', 'UR', '2R', 'X', '4D', 'X'], ['3D', 'X', '2L', 'UD', 'X', 'X', 'X', 'X'], ['X', 'X', 'X', 'DR', '2R', 'X', '2D', 'X'], ['X', 'X', 'X', '3R', 'X', 'X', 'D', 'X']]), ([47144, 112661, 17978, 375739, 72108, 98842, 275528], [76456, 208930, 223353, 127840, 247912, 84863, 30646], 17, [['10D', '3D', '5D', '11D', '9D', '14D', '5D'], ['X', '16D', 'X', 'X', 'X', 'X', 'X'], ['X', 'UR', '3R', 'X', 'X', '15D', 'X'], ['X', 'UD', '4R', 'X', '14D', 'L', '14D'], ['13D', 'DL', 'UR', '3R', '13D', 'UL', '13D'], ['X', '2R', 'UD', '12D', 'X', 'UD', 'L'], ['X', '11D', 'DR', '11D', '3L', 'DL', 'X'], ['X', '10D', '4R', '10D', '3L', '2L', '10D'], ['9D', 'L', 'X', 'X', 'UR', '9D', 'X'], ['8D', 'UL', '8D', 'L', 'UD', 'X', 'X'], ['R', 'UD', '7D', 'UL', 'DR', 'R', '7D'], ['X', 'DR', '3R', 'UD', '6D', '6D', 'X'], ['X', 'R', '5D', 'DR', '5D', '5D', 'X'], ['4D', '4D', 'X', '2L', '4L', 'UL', 'X'], ['X', 'X', 'X', 'X', 'X', 'UD', 'X'], ['X', 'X', 'X', '2D', 'L', 'DL', 'X'], ['X', 'X', 'D', 'X', 'X', '3L', 'X']]), ([47577, 59847, 18530, 20702, 410100, 123940, 310706, 8598], [273313, 130797, 58492, 63443, 53932, 374268, 8870, 36885], 19, [['16D', '3D', '7D', '11D', '15D', '6D', '12D', '3D'], ['X', '18D', 'X', 'X', 'X', 'X', '18D', 'X'], ['X', 'UR', 'R', '17D', '17D', 'L', 'UL', 'X'], ['X', 'RUD', '16D', 'X', '16D', 'L', 'LUD', 'L'], ['15D', 'DL', '15D', 'X', 'X', '3L', 'DR', '15D'], ['X', '14D', '14D', '14D', 'L', 'UL', '14D', 'X'], ['X', 'X', 'UR', '3R', '13D', 'LUD', '13D', 'X'], ['X', '12D', 'LUD', '12D', 'L', 'DL', 'X', 'X'], ['11D', 'X', 'DR', '3R', 'X', '5L', '11D', 'X'], ['X', 'X', '4R', '10D', 'X', 'X', '10D', 'X'], ['X', '9D', 'X', 'UR', '9D', 'X', '5L', 'X'], ['X', 'X', '8D', 'LUD', 'X', '8D', 'UL', 'X'], ['7D', 'X', 'X', 'DR', '7D', '5L', 'LUD', 'X'], ['6D', '6D', 'X', '4R', '4L', '4L', 'DL', '6D'], ['5D', '6R', 'X', '3L', 'UL', '5D', 'L', '5D'], ['X', 'UR', '4D', 'X', 'RUD', '4D', 'X', 'X'], ['R', 'RUD', '5R', 'X', 'DR', '3D', 'X', '3D'], ['X', 'DR', '5R', 'X', 'R', '2D', 'X', '2D'], ['X', '2R', 'X', 'D', 'X', 'X', 'X', 'X']]), ([378077, 94650, 24592, 11119, 14710, 88919, 219416, 15408, 141406, 11703], [93472, 16293, 96870, 13213, 44379, 51684, 280953, 247965, 52055, 103116], 23, [['3D', '19D', '7D', '12D', '17D', '3D', '12D', '8D', '15D', '20D'], ['X', '5R', 'X', 'X', 'X', '22D', '22D', 'X', 'X', 'X'], ['X', 'UR', '5R', 'X', 'X', 'UR', '3R', '21D', 'X', '21D'], ['R', 'UD', 'X', 'X', 'X', 'UD', 'X', 'X', 'X', 'X'], ['19D', 'DR', '4R', 'X', '4L', 'DL', '19D', 'X', 'X', 'X'], ['X', '6R', '6R', 'X', 'X', '4R', 'X', '18D', '18D', '18D'], ['X', 'X', 'UR', '5R', 'X', 'X', 'X', '17D', '17D', 'X'], ['X', 'X', 'UD', 'X', 'X', 'X', 'X', 'UR', 'R', '16D'], ['X', '15D', 'DL', 'X', 'X', 'X', 'X', 'UD', 'X', 'X'], ['X', 'X', '6R', '14D', 'X', 'X', '3L', 'DL', '14D', 'X'], ['X', 'X', '13D', 'R', '13D', 'X', '13D', '5L', 'X', 'X'], ['X', '12D', 'L', 'UL', 'X', 'X', 'UR', '12D', 'X', 'X'], ['X', 'X', 'X', 'UD', 'X', 'X', 'UD', 'X', 'X', 'X'], ['X', 'X', '10D', 'DR', '10D', 'X', 'DR', '2R', '6L', '10D'], ['X', 'X', '9D', '9D', '9D', 'X', '4L', '3L', 'UL', 'X'], ['X', '8D', 'X', 'X', '3L', 'X', 'X', 'X', 'UD', 'X'], ['X', '7D', 'X', '2L', 'UL', 'X', '7D', 'L', 'DL', 'X'], ['6D', 'L', 'X', 'X', 'UD', 'X', 'X', 'X', '6D', 'X'], ['5D', 'UL', '5D', '5D', 'DL', 'X', 'X', 'X', '6L', 'X'], ['X', 'UD', 'X', 'X', '4D', '4D', 'X', '2L', 'UL', 'X'], ['X', 'DR', '3R', 'X', 'X', '3D', 'X', 'X', 'UD', 'L'], ['2D', 'L', 'X', 'X', 'X', '2D', 'X', '2L', 'DL', 'X'], ['X', 'X', 'X', 'D', 'X', 'X', 'X', 'X', '5L', 'X']]), ([29340, 107131, 156056, 22092, 20206, 260015, 220874, 184286], [87157, 100268, 76765, 81979, 131229, 133071, 219315, 170216], 19, [['3D', '13D', '8D', '3D', '7D', '15D', '3D', '8D'], ['X', '18D', 'X', '18D', 'X', 'X', '18D', 'X'], ['17D', 'UL', '17D', 'UL', '17D', 'L', 'UL', 'X'], ['R', 'UD', 'X', 'UD', 'X', 'X', 'UD', 'X'], ['15D', 'DL', 'X', 'DR', '15D', '15D', 'DL', 'X'], ['X', '14D', '14D', '14D', '2L', 'X', '14D', 'X'], ['X', 'X', '13D', '13D', 'UL', 'X', '13D', 'X'], ['X', '12D', 'UR', '4R', 'UD', '4L', 'UL', '12D'], ['X', 'X', 'UD', 'X', 'DR', '11D', 'UD', 'L'], ['10D', '10D', 'DL', 'X', '10D', '5L', 'DL', 'X'], ['X', 'X', '5R', 'X', 'X', '9D', 'L', '9D'], ['X', 'R', '8D', 'X', 'X', 'X', 'X', 'X'], ['X', 'UR', '3R', 'X', 'X', '7D', 'X', 'X'], ['X', 'UD', 'X', 'X', '6D', 'L', 'X', 'X'], ['X', 'DR', '5R', '5D', 'L', 'UL', 'X', '5D'], ['4D', 'L', 'X', 'X', 'X', 'UD', 'X', 'X'], ['X', 'X', 'X', 'X', 'X', 'DR', 'R', '3D'], ['X', 'X', 'X', 'X', 'X', 'R', '2D', 'X'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X']])]
...
def main():
    ...
    use_maxhalf = ((C==6 and 427657<=M<=481244) or
