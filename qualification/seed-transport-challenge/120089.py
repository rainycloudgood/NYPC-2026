...
# Rating v2: public1=23,850; C9/C8/C6 tails strengthened; C7/8 max-half blocked.
import random
import itertools
import sys
...
def main():
    ...
    # Preserve the C=5/6 bands where the intermediate table shows real gains,
    # but exclude the confirmed catastrophic C=7/band1 and C=8/band2 tails.
    use_maxhalf = ((C==5 and M>=479292) or
                   (C==6 and M<=376195) or
                   (C==6 and 427657<=M<=481244))
    if use_maxhalf:
