...
PUBLIC1_PHASE_GRID=[
 ['2D','5D','8D','2D','D','8D','2D','5D'],
 ['12D','X','X','10D','4D','X','14D','X'],
 ['URD','16D','X','URD','15D','X','URD','13D'],
 ['DR','8D','X','DR','14D','X','DR','12D'],
 ['7D','10D','X','8D','12D','X','12D','12D'],
 ['X','URD','9D','X','URD','13D','10D','ULD'],
 ['X','DR','6D','X','DR','7D','7D','DL'],
 ['X','5D','5D','X','D','11D','X','11D'],
 ['X','X','URD','3D','8D','URD','5D','X'],
 ['X','X','DR','D','X','DR','5D','X'],
 ['X','X','7D','7D','X','4D','X','X'],
 ['8D','L','L','L','L','L','L','L'],
 ['R','7D','L','L','L','L','L','L'],
