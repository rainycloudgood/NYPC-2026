...
KNOWN_CASES=[([71780, 40734, 34823, 21664, 386738, 78532, 252360, 113369], [43797, 25501, 136827, 63769, 243154, 274570, 17689, 194693], 17, [['D', '3D', '5D', '7D', '9D', '11D', '13D', '15D'], ['3R', 'X', 'X', '16D', 'X', 'X', 'X', 'X'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'], ['5R', 'LDR', '4R', 'X', 'X', '14D', '14D', 'X'], ['X', '5R', 'X', 'X', 'X', 'X', '13D', 'X'], ['12D', '12D', 'RLD', '3L', 'X', 'X', 'X', 'X'], ['X', '11D', 'L', 'X', 'X', 'X', 'X', 'X'], ['10D', 'X', '2L', 'LDR', '2R', 'X', '10D', 'X'], ['X', '9D', 'X', '2L', 'X', 'X', 'X', 'X'], ['X', 'X', 'X', '4R', 'DRL', '8D', 'X', '8D'], ['X', 'X', 'X', 'X', 'R', '7D', 'X', 'X'], ['6D', 'X', 'X', 'X', '4L', 'LDR', 'R', '6D'], ['X', 'X', 'X', 'X', 'X', '2R', 'X', '5D'], ['X', 'X', 'X', 'X', '4D', 'X', '2L', 'X'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'], ['X', 'X', '2D', 'X', 'X', 'X', 'X', '5L'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X']]), ([47577, 59847, 18530, 20702, 410100, 123940, 310706, 8598], [273313, 130797, 58492, 63443, 53932, 374268, 8870, 36885], 17, [['D', '3D', '5D', '7D', '9D', '11D', '13D', '15D'], ['2R', 'X', '16D', 'X', 'X', 'X', 'X', 'X'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'], ['3R', 'DLR', '5R', '14D', 'X', 'X', 'X', '14D'], ['X', '13D', 'X', 'X', 'X', 'X', 'X', 'X'], ['X', '3R', 'RLD', '12D', '12D', 'X', 'X', 'X'], ['X', 'X', '2R', 'X', '11D', 'X', 'X', 'X'], ['X', '10D', 'L', 'LDR', '3R', 'X', 'X', '10D'], ['X', 'X', 'X', '4R', 'X', 'X', 'X', '9D'], ['8D', 'X', 'X', '3L', 'LDR', '8D', 'X', 'X'], ['X', 'X', 'X', 'X', 'R', '7D', 'X', 'X'], ['6D', 'X', 'X', '6D', '4L', 'LRD', '3L', 'X'], ['X', 'X', 'X', 'X', '5D', 'L', 'X', 'X'], ['4D', '4D', 'X', 'X', 'X', '5L', 'LRD', '6L'], ['X', 'X', 'X', 'X', 'X', '3D', 'L', 'X'], ['X', 'X', 'X', 'X', 'X', 'X', '2D', 'L'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X']]), ([378077, 94650, 24592, 11119, 14710, 88919, 219416, 15408, 141406, 11703], [93472, 16293, 96870, 13213, 44379, 51684, 280953, 247965, 52055, 103116], 23, [['2D', '4D', '6D', '8D', '10D', '12D', '14D', '16D', '18D', '21D'], ['X', '5R', 'X', 'X', 'X', 'X', '22D', 'X', 'X', 'X'], ['R', 'UDR', '4R', 'X', 'X', 'X', '21D', 'X', 'X', 'X'], ['X', '6R', 'X', 'X', 'X', 'X', 'X', '20D', 'X', 'X'], ['X', 'R', '19D', 'X', 'X', 'X', 'X', 'X', 'X', 'X'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'], ['17D', 'L', 'LDR', 'R', '17D', 'X', 'X', 'X', 'X', 'X'], ['16D', 'X', '2L', 'X', 'X', 'X', 'X', 'X', 'X', 'X'], ['X', 'X', '6R', 'LDR', 'R', '15D', 'X', 'X', '15D', 'X'], ['X', 'X', 'X', '6R', 'X', 'X', 'X', 'X', 'X', '14D'], ['X', '13D', 'X', '13D', 'RLD', '4L', 'X', 'X', 'X', 'X'], ['X', 'X', 'X', '12D', 'L', 'X', 'X', 'X', 'X', 'X'], ['X', 'X', 'X', 'X', '11D', 'LDR', '11D', 'X', 'X', 'X'], ['X', 'X', 'X', 'X', 'X', '4R', 'X', 'X', 'X', '10D'], ['9D', 'X', 'X', 'X', 'X', '5L', 'LDR', '2R', 'X', '9D'], ['X', 'X', 'X', 'X', 'X', 'X', 'R', '8D', 'X', 'X'], ['X', '7D', 'X', 'X', '7D', 'X', '5L', 'LRD', '4L', 'X'], ['X', '6D', 'X', 'X', 'X', 'X', 'X', '6L', 'X', 'X'], ['X', 'X', 'X', 'X', 'X', '5D', 'X', '5D', 'LRD', '4L'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', '4D', 'X'], ['X', 'X', 'X', '3D', 'X', 'X', 'X', 'X', '5L', 'X'], ['X', 'X', 'X', 'X', 'X', '2D', 'X', '2L', 'UDL', 'L'], ['X', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'D', 'X']])]
